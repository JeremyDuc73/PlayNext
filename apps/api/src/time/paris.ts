...
export function defaultEveningScheduledAt(instant = new Date()): Date {
  return parisLocalToUtc(parisYmd(instant), "21:00");
}

export function formatParisWhen(value: string | Date): string {
